...
ALTER TABLE PUBLIC.REVIEWS
    ADD CONSTRAINT FK_REVIEWS_USER_ID FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS (USER_ID) ON DELETE CASCADE;
ALTER TABLE PUBLIC.REVIEWS
    ADD CONSTRAINT FK_REVIEWS_FILM_ID FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILMS (FILM_ID) ON DELETE CASCADE;

ALTER TABLE PUBLIC.REVIEW_MARKS
    ADD CONSTRAINT FK_REVIEW_MARKS_REVIEW_ID FOREIGN KEY (REVIEW_ID) REFERENCES PUBLIC.REVIEWS (REVIEW_ID) ON DELETE CASCADE;
ALTER TABLE PUBLIC.REVIEW_MARKS
    ADD CONSTRAINT FK_REVIEW_MARKS_USER_ID FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS (USER_ID) ON DELETE CASCADE;

ALTER TABLE PUBLIC.FEEDS
    ADD CONSTRAINT FK_FEEDS_USER_ID FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS (USER_ID);
ALTER TABLE PUBLIC.FEEDS
    ADD CONSTRAINT FK_FEEDS_ENTITY_USER_ID FOREIGN KEY (ENTITY_ID) REFERENCES PUBLIC.USERS (USER_ID);
ALTER TABLE PUBLIC.FEEDS
    ADD CONSTRAINT FK_FEEDS_ENTITY_FILM_ID FOREIGN KEY (ENTITY_ID) REFERENCES PUBLIC.FILMS (FILM_ID);

ALTER TABLE PUBLIC.FILM_DIRECTORS
    ADD CONSTRAINT FK_FILM_DIRECTORS_FILM_ID FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILMS (FILM_ID);
ALTER TABLE PUBLIC.FILM_DIRECTORS
    ADD CONSTRAINT FK_FILM_DIRECTORS_DIRECTOR_ID FOREIGN KEY (DIRECTOR_ID) REFERENCES PUBLIC.DIRECTORS (DIRECTOR_ID);