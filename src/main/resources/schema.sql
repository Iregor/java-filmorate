...
ALTER TABLE PUBLIC.REVIEWS
    ADD CONSTRAINT FK_REVIEWS_FILM_ID FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILMS (FILM_ID);

ALTER TABLE PUBLIC.REVIEW_MARKS
    ADD CONSTRAINT FK_REVIEW_MARKS_REVIEW_ID FOREIGN KEY (REVIEW_ID) REFERENCES PUBLIC.REVIEWS (REVIEW_ID);
ALTER TABLE PUBLIC.REVIEW_MARKS
    ADD CONSTRAINT FK_REVIEW_MARKS_USER_ID FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS (USER_ID);
