...
(
    ...
    CONSTRAINT FK_FILM_GENRES_GENRES_ID FOREIGN KEY (GENRE_ID) REFERENCES GENRES (GENRE_ID) ON DELETE CASCADE
);
...
(
    ...
    ENTITY_ID  BIGINT                                              NOT NULL CHECK
        ((EVENT_TYPE IN ('LIKE', 'REVIEW') AND ENTITY_ID IN (SELECT FILM_ID
                                                             FROM FILMS))
            OR ((EVENT_TYPE = 'FRIEND') AND ENTITY_ID IN (SELECT USER_ID
                                                          FROM USERS))),
    CONSTRAINT FK_FEEDS_USER_ID FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS (USER_ID) ON DELETE CASCADE,
    CONSTRAINT FK_FEEDS_ENTITY_USER_ID FOREIGN KEY (ENTITY_ID) REFERENCES PUBLIC.USERS (USER_ID) ON DELETE CASCADE,
    CONSTRAINT FK_FEEDS_ENTITY_FILM_ID FOREIGN KEY (ENTITY_ID) REFERENCES PUBLIC.FILMS (FILM_ID) ON DELETE CASCADE
);
